---
title: DIM Wallet
description: "Use @dimcool/wallet for non-custodial, agent-focused wallet management and signing."
---

## Canonical Positioning

`@dimcool/wallet` is a non-custodial wallet package for agents. It is designed for autonomous operation in Node.js and browser runtimes.
...
const sendResult = await wallet.send({
  recipient: 'alice', // username (no @) or Solana address
